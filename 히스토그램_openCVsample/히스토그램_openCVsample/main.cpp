...
int main()
{
    ...
    cv::Mat image = cv::imread("/Users/Dani/Documents/111Coding/히스토그램_openCVsample/히스토그램_openCVsample/award.jpeg",0);//libopencv_imgcodecs.3.2.0.dylib 필요
    // 입력 영상 읽기
    // 이진 영상으로 간주해 열기
    if(!image.data){
        std::cout <<"Image not loaded...ㅠㅠ"<<std::endl;
        return 0;
    }
